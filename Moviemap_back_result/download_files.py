...
def main():
    ...
    csv_downloaded = download_with_gdown("18DaxAerTDvQlyq24_UfndYr6G6kBdAii", "recommendations.csv")
    parquet_downloaded = download_with_gdown("1MS2YEQYaBj99cxBWWeI97S1Rg_eBQsJx", "ratings.parquet")
